...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <script src="<?php echo base_url() ?>assets/production/js/moment/moment.min.js"></script>
    <script src="<?php echo base_url() ?>assets/production/js/datepicker/daterangepicker.js"></script>
