...
<head>
	...
	<body>
		<div class="container">
			...
			<form method="post" action="<?php echo base_url() ?>index.php/admin/do_edit">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="form-group">
							...
							<select class="form-control" name="participant_type" value="<?php echo $data->id_participant ?>">
							...
							<select class="form-control" name="attend_confirmation" value="<?php echo $data->id_attend_confirmation ?>">
